...
!function() {
  ...
  var O = {
      ...
      updateSlides: function() {
          ...
          for (let a = 0; a < m; a += 1) {
              ...
              !c[a] || "none" !== w(r, "display")) {
                  ...
                  v.push(z),
                  i.centeredSlides ? (T = T + z / 2 + M / 2 + A,
                  0 === M && 0 !== a && (T = T - n / 2 - A),
                  0 === a && (T = T - n / 2 - A),
                  Math.abs(T) < .001 && (T = 0),
                  i.roundLengths && (T = Math.floor(T)),
                  C % i.slidesPerGroup == 0 && h.push(T),
                  g.push(T)) : (i.roundLengths && (T = Math.floor(T)),
                  (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && h.push(T),
                  g.push(T),
                  T = T + z + A),
                  e.virtualSize += z + A,
                  M = z,
          ...
          i.centeredSlides && i.cssMode && !i.centeredSlidesBounds) {
              ...
              u(a, "--swiper-centered-offset-after", e.size / 2 - v[v.length - 1] / 2 + "px");
              const t = -e.snapGrid[0]
                , s = -e.slidesGrid[0];
              e.snapGrid = e.snapGrid.map((e => e + t)),
              e.slidesGrid = e.slidesGrid.map((e => e + s))
          }
          if (m !== p && e.emit("slidesLengthChange"),
      ...
      updateActiveIndex: function(e) {
          ...
          d === r)
              ...
              void (t.params.loop && t.virtual && t.params.virtual.enabled && (t.realIndex = p(d)));
          let c;
  ...
  function Y(e) {
      ...
      !o.touchStartForcePreventDefault && !E || u.isContentEditable || c.preventDefault(),
  ...
  function H(e) {
      ...
      v > 0 ? (y && !x && a.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({
          direction: "prev",
          setTranslate: !0,
          activeSlideIndex: 0
      }),
      a.currentTranslate > s.minTranslate() && (E = !1,
      r.resistance && (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + v) ** S))) : v < 0 && (y && !x && a.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.size / 2 : s.maxTranslate()) && s.loopFix({
          direction: "next",
          setTranslate: !0,
          activeSlideIndex: s.slides.length - ("auto" === r.slidesPerView ? s.slidesPerViewDynamic() : Math.ceil(parseFloat(r.slidesPerView, 10)))
      }),
      a.currentTranslate < s.maxTranslate() && (E = !1,
      r.resistance && (a.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - a.startTranslate - v) ** S))),
  ...
  function N(e) {
      ...
      if (t.allowClick) {
          ...
          t.emit("tap click", c),
          m < 300 && u - s.lastClickTime < 300 && t.emit("doubleTap doubleClick", c)
      }
      ...
      s.isMoved = !1,
      s.startMoving = !1,
      h = a.followFinger ? o ? t.translate : -t.translate : -s.currentTranslate,
      a.cssMode)
          return;
      ...
      if (m > a.longSwipesMs) {
          ...
          if (!a.shortSwipes)
              return void t.slideTo(t.activeIndex);
          t.navigation && (c.target === t.navigation.nextEl || c.target === t.navigation.prevEl) ? c.target === t.navigation.nextEl ? t.slideTo(f + y) : t.slideTo(f) : ("next" === t.swipeDirection && t.slideTo(null !== v ? v : f + y),
  ...
  const Z = {
      ...
      events: {
          attachEvents: function() {
              ...
              e.onClick = X.bind(e),
              e.onLoad = F.bind(e),
              j || (t.addEventListener("touchstart", q),
              j = !0),
              V(e, "on")
          },
  ...
  const ce = [function(e) {
      ...
      function d(e, t) {
          ...
          a = o.children[0])) : a = s.isElement ? g("swiper-slide") : g("div", s.params.slideClass),
      ...
      function p(e) {
          ...
          for (let t = C; t < P; t += 1)
              if (t >= y && t <= x) {
                  const s = M(t);
                  void 0 === c || e ? T.push(s) : (t > c && T.push(s),
                  t < p && A.push(s))
              }
          if (T.forEach((e => {
  ...
  , function(e) {
      ...
      function f(e) {
          return !(t.params.mousewheel.thresholdDelta && e.delta < t.params.mousewheel.thresholdDelta) && (!(t.params.mousewheel.thresholdTime && l() - c < t.params.mousewheel.thresholdTime) && (e.delta >= 6 && l() - c < 60 || (e.direction < 0 ? t.isEnd && !t.params.loop || t.animating || (t.slideNext(),
  ...
  , function(e) {
      ...
      function u() {
          ...
          "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
              ...
              let o, d, u;
              if (s.dynamicBullets && (n = E(a[0], t.isHorizontal() ? "width" : "height", !0),
              c.forEach((e => {
      ...
      i("click", ( (e, s) => {
          ...
          t.params.pagination.el && t.params.pagination.hideOnClick && r && r.length > 0 && !i.classList.contains(t.params.pagination.bulletClass)) {
  ...
  , function(e) {
      ...
      function y(e) {
          const {scrollbar: s, rtlTranslate: i} = t
            , {el: a} = s;
          let r;
          r = (b(e) - v(a)[t.isHorizontal() ? "left" : "top"] - (null !== o ? o : d / 2)) / (p - d),
      ...
      function T() {
          ...
          a && (r = a.querySelector(`.${t.params.scrollbar.dragClass}`),
      ...
      a("init", ( () => {
          !1 === t.params.scrollbar.enabled ? C() : (T(),
          w(),
          f())
      }
      )),
  ...
  , function(e) {
      ...
      function E(e) {
          ...
          !(u.length < 2)) {
              ...
              !m.slideEl) {
                  ...
                  m.imageEl = i,
                  m.imageWrapEl = i ? y(m.imageEl, `.${s.containerClass}`)[0] : void 0,
                  !m.imageWrapEl)
      ...
      function C(e) {
          ...
          if (!m.slideEl) {
              ...
              m.imageEl = s,
              m.imageWrapEl = s ? y(m.imageEl, `.${i.containerClass}`)[0] : void 0
          }
  ...
  , function(e) {
      ...
      function h(e) {
          ...
          const s = t.params.a11y
            , i = e.target;
          t.pagination && t.pagination.el && (i === t.pagination.el || t.pagination.el.contains(e.target)) && !e.target.matches(te(t.params.pagination.bulletClass)) || (t.navigation && t.navigation.nextEl && i === t.navigation.nextEl && (t.isEnd && !t.params.loop || t.slideNext(),
      ...
      i("paginationUpdate", ( () => {
          t.params.a11y.enabled && function() {
              ...
              f() && t.pagination.bullets.forEach((s => {
                  ...
                  c(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, b(s) + 1)))),
  ...
  , function(e) {
      ...
      let d, p, c, u, m, h, f, g = o && o.autoplay ? o.autoplay.delay : 3e3, v = o && o.autoplay ? o.autoplay.delay : 3e3, w = (new Date).getTime;
      function b(e) {
      ...
      const y = () => {
        ...
        , x = e => {
          ...
          const n = a.params.speed
            , o = () => {
              ...
              l("autoplay")),
              a.params.cssMode && (w = (new Date).getTime(),
              requestAnimationFrame(( () => {
                  x()
              }
              ))))
        ...
        , A = (e, s) => {
          ...
          const i = () => {
              l("autoplayPause"),
              a.params.autoplay.waitForTransition ? a.wrapperEl.addEventListener("transitionend", b) : T()
          }
          ;
        ...
        , T = () => {
          a.isEnd && d < 0 && !a.params.loop || a.destroyed || !a.autoplay.running || (w = (new Date).getTime(),
          f ? (f = !1,
          x(d)) : x(),
          a.autoplay.paused = !1,
          l("autoplayResume"))
      ...
      n("sliderFirstMove", ( () => {
          !a.destroyed && a.autoplay.running && (a.params.autoplay.disableOnInteraction ? S() : (c = !0,
          u = !1,
          f = !1,
          m = setTimeout(( () => {
              f = !0,
  ...
  , function(e) {
      ...
      const a = (e, t, s) => {
          ...
          i || (i = g("div", "swiper-slide-shadow-" + (s ? "left" : "top")),
          e.append(i)),
          a || (a = g("div", "swiper-slide-shadow-" + (s ? "right" : "bottom")),
          e.append(a)),
      ...
      le({
          ...
          setTranslate: () => {
              ...
              let m, h = 0;
              p.shadow && (c ? (m = t.slidesEl.querySelector(".swiper-cube-shadow"),
      ...
      l.forEach((e => {
          ...
          if (t) {
              ...
              if (!n.includes(t))
                  return;
              const s = ge(e.value);
              a[t] && ve.includes(e.name) ? (a[t].constructor !== Object && (a[t] = {}),
              a[t].enabled = s) : a[t] = s
          }
      }
      )),
  ...
  const xe = (e, t) => {
      ...
      s && !i || (s = s || document.createElement("style"),
  ...
  ;
  const Ee = "undefined" == typeof window || "undefined" == typeof HTMLElement ? class {
  }
  : HTMLElement;
  class Se extends Ee {
      constructor() {
      ...
      render() {
          ...
          var t;
          e.length && (this.stylesEl = document.createElement("style"),
          this.stylesEl.textContent = e,
          this.shadowEl.appendChild(this.stylesEl)),
          this.cssLinks().forEach((e => {
              if (this.shadowEl.querySelector(`link[href="${e}"]`))
                  return;
              const t = document.createElement("link");
              t.rel = "stylesheet",
              t.href = e,
      ...
      updateSwiperOnPropChange(e, t) {
          ...
          function(e) {
              ...
              d.forEach((e => {
                  if (me(p[e]) && me(i[e]))
                      he(p[e], i[e]),
                      "navigation" !== e && "pagination" !== e && "scrollbar" !== e || !("enabled"in i[e]) || i[e].enabled || A(e);
                  else {
                      const t = i[e];
  ...
  class Ae extends Ee {
      ...
      render() {
          ...
          if (this.tempDiv.innerHTML = "<slot />",
          [...this.tempDiv.children].forEach((e => {
              this.shadowEl.appendChild(e)
          }
          )),
  ...
  void 0 === Te && (Te = !0),
  "undefined" != typeof window && (Te || (ye = !1),
  ye && xe(!0),
  window.customElements.get("swiper-container") || window.customElements.define("swiper-container", Se),
